...
module.exports = {
        ...
        target.forEach((entry) => {
            ...
            if (entry.hasOwnProperty('boFrequency')) {
                ...
                entry.forEach((e) => {
                    ...
                    if (entry.hasOwnProperty('bofTimes')) {
                        arr.push(entry.bofTimes);
                    }
                    if (entry.hasOwnProperty('bofPeriodStartTime')) {
                        arr.push(entry.bofPeriodStartTime);
                    }
                    if (entry.hasOwnProperty('bofPeriodEndTime')) {
                        arr.push(entry.bofPeriodEndTime);
                    }
                    if (entry.hasOwnProperty('bofMemo')) {
                        arr.push(entry.bofMemo);
                    }
    ...
    build: function (target, arr) {
        ...
        if (target.hasOwnProperty('VitalSignModule')) {
            this.buildVitalSignModule(target.VitalSignModule, arr);
        }
