...
const CONTENT_MODULE_TYPE = ['prescription', 'test', 'patientInfo', 'registeredDiagnosis'];
const BUILDERS = [prescriptionBuilder, labTestBuilder, patientBuilder, diagnosisBuilder]
...
module.exports = {
    ...
    buildNameSpace: function() {
        var arr = [
            ...
            'xsi:schemaLocation="http://www.medxml.net/MML/v4/mml.xsd"'
        ];
        return arr.join('');
    },
