...
const CONTENT_MODULE_TYPE = ['prescription', 'test', 'patientInfo', 'registeredDiagnosis', 'vitalsign'];
const BUILDERS = [prescriptionBuilder, labTestBuilder, patientBuilder, diagnosisBuilder, vitalSignBuilder]
