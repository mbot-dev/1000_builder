...
var surgeryItem = {
    surgicalInfo: {                                     // 手術ヘッダー情報
        ...
        surgicalDepartment: [],                         // 手術実施診療科情報 ? mmlDp:Departmentの配列
        patientDepartment: []                           // 手術時に患者の所属していた診療科 ? mmlDp:Departmentの配列 説明X
    },
    surgicalDiagnosis: [],                              // 外科診断情報 mmlRd:RegisteredDiagnosisModuleの配列
    surgicalProcedure: [],                              // 手術法情報 procedureItemの配列
    surgicalStaffs: [],                                 // 麻酔を除く手術スタッフの情報 ? staffの配列
...
var staff = {
    ...
    staffInfo: {}                                       // スタッフ ID 情報 mmlPsi:PersonalizedInfo            xsd確認 []
};
*******************************************************************************/
