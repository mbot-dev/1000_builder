...
module.exports = {
    ...
    buildInformation: function(info) {
    ...
    buildLaboTest:function(laboTest) {
        var array = [];
        ...
        laboTest.item.forEach((entry) => {
            array.push(this.buildItem(entry));
        });
    ...
    build: function(test) {
        ...
        array.push(this.buildInformation(test.information));
        test.laboTest.forEach((entry) => {
            array.push(this.buildLaboTest(entry));
        });
        array.push('</mmlLb:TestModule>');
        return array.join('');
    }
