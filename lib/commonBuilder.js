...
module.exports = {
    ...
    buildFacility: function(target) {
        ...
        arr.push(this.buildId(target.Id));
        arr.push('</mmlFc:Facility>');
        return arr.join('');
    },

    // Department
    buildDepartment: function(target) {
        var arr = [];
    ...
    buildAddresses: function(target) {
        ...
        target.forEach((entry) => {
            arr.push(this.buildAddress(entry));
        });
        arr.push('</mmlPsi:addresses>');
        return arr.join('');
    },
    ...
    buildEmailAddresses: function(target) {
        ...
        target.forEach((entry) => {
            arr.push(this.buildEmail(entry));
        });
        arr.push('</mmlPsi:emailAddresses>');
        return arr.join('');
    },
    ...
    buildPhones: function(target) {
        ...
        target.forEach((entry) => {
            arr.push(this.buildPhone(entry));
        });
        arr.push('</mmlPsi:phones>');
        return arr.join('');
    },
    ...
    // creatorLicense
    buildCreatorLicense: function(target) {
        var arr = [];
        target.forEach((entry) => {
    ...
    // CreatorInfo
    buildCreatorInfo: function(target) {
        var arr = [];
        arr.push('<mmlCi:CreatorInfo>');
        arr.push(this.buildPersonalizedInfo(target.PersonalizedInfo));
        if (target.hasOwnProperty('creatorLicense')) {
            arr.push(this.buildCreatorLicense(target.creatorLicense));
        }
        arr.push('</mmlCi:CreatorInfo>');
        return arr.join('');
    }
