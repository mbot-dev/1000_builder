...
var childhood = {                                           // 出生時情報
    ...
    vaccination: []                                         // 予防接種情報 ? vaccinationItemの配列
};
...
var pastHistory = {                                         // 既往歴情報 選択
    freeNotes: '',                                          // 自由文章表現
    pastHistoryItem: []                                     // 時間表現併用
};

var pastHistoryItem = {
    timeExpression: '',                                     // 時間表現
    eventExpression: []                                     // 時間表現に対応するイベント表現 ? string array
};
******************************************************************************/
...
module.exports = {
    ...
    buildChildhood: function (target, arr) {
        ...
        if (target.hasOwnProperty('birthInfo')) {
            var birthInfo = target.birthInfo;
