...
module.exports = {
    ...
    buildObservedTime: function(value) {
        var arr = [];
    ...
    build: function(target) {
        ...
        if (target.hasOwnProperty('context')) {
            arr.push(this.buildContext(target.context));
        }
        arr.push(this.buildItem(target.item));
        arr.push(this.buildObservedTime(target.observedTime));
        if (target.hasOwnProperty('protocol')) {
            arr.push(this.buildProtocol(target.protocol));
        }
        if (target.hasOwnProperty('vsMemo')) {
            arr.push(this.buildVsMemo(target.vsMemo));
        }
        arr.push('</mmlVs:VitalSignModule>');
        return arr.join('');
    }
